<template>
  <div class="h-full">
    <div v-if="yesterdayResultList.length > 0" class="max-h-40 flex pt-2 overflow-x-auto sellBox">
      <div class="sellItem relative p-1" v-for="(item,index) in yesterdayResultList" :key="index">
        <div>
